...
OFFICIAL_KEYS = {
    "P1": {  # General English (Paper-I) - 50 Questions [Sets I, J, K, L]
        "Set-I (Set-1)": {
        ...
        "Set-J (Set-2)": {
            1: "Deleted", 2: "A", 3: "C", 4: "C", 5: "B", 6: "C", 7: "A", 8: "D", 9: "C", 10: "B",
            11: "C", 12: "B", 13: "B", 14: "C", 15: "B", 16: "C", 17: "D", 18: "B", 19: "C", 20: "D",
            21: "A", 22: "B", 23: "C", 24: "B", 25: "B", 26: "D", 27: "D", 28: "C", 29: "B", 30: "C",
            31: "C", 32: "C", 33: "A", 34: "D", 35: "D", 36: "B", 37: "D", 38: "C", 39: "A", 40: "B",
            41: "C", 42: "B", 43: "C", 44: "D", 45: "D", 46: "A", 47: "A", 48: "A", 49: "B", 50: "C"
        },
        "Set-K (Set-3)": {
            1: "A", 2: "A", 3: "D", 4: "B", 5: "C", 6: "C", 7: "A", 8: "A", 9: "Deleted", 10: "B",
            11: "B", 12: "D", 13: "C", 14: "B", 15: "B", 16: "C", 17: "B", 18: "D", 19: "C", 20: "C",
            21: "C", 22: "C", 23: "C", 24: "B", 25: "D", 26: "C", 27: "D", 28: "A", 29: "A", 30: "D",
            31: "A", 32: "B", 33: "A", 34: "D", 35: "B", 36: "A", 37: "D", 38: "D", 39: "C", 40: "C",
            41: "A", 42: "A", 43: "C", 44: "D", 45: "D", 46: "B", 47: "C", 48: "A", 49: "A", 50: "A"
        },
        "Set-L (Set-4)": {
            1: "D", 2: "A", 3: "B", 4: "B", 5: "B", 6: "Deleted", 7: "B", 8: "C", 9: "A", 10: "C",
            11: "C", 12: "B", 13: "D", 14: "B", 15: "D", 16: "C", 17: "B", 18: "B", 19: "C", 20: "C",
            21: "A", 22: "D", 23: "D", 24: "D", 25: "C", 26: "A", 27: "D", 28: "A", 29: "B", 30: "B",
            31: "D", 32: "B", 33: "B", 34: "C", 35: "A", 36: "C", 37: "D", 38: "B", 39: "A", 40: "D",
            41: "A", 42: "B", 43: "B", 44: "D", 45: "A", 46: "A", 47: "B", 48: "C", 49: "A", 50: "A"
        }
    },
...
def parse_omr_file(uploaded_file):
    """Extracts answers from student's uploaded OMR Sheet (PDF or Image)."""
    responses = {}
    ...
    if file_ext in ["jpg", "jpeg", "png"]:
        # Simulated responses for demo image inputs
        responses = {1: "C", 2: "C", 3: "A", 4: "B", 5: "A", 6: "B", 7: "D", 8: "A", 9: "B", 10: "B"}
    ...
    if not responses:
        # Fallback default values if no data is detected in uploaded OMR file
...
def evaluate_paper(student_responses, official_key):
    """
    Evaluates paper according to official criteria:
    - Correct: +2 Marks
    - Incorrect / Unattempted: 0 Marks
    - Deleted Question: +2 Bonus Marks (automatically applied per official key)
    """
    ...
    bonus_marks = deleted * 2  # +2 Bonus for every deleted question
...
# --- UI SETUP ---
st.set_page_config(page_title="BPSC Automatic OMR Evaluator & Merit Leaderboard", layout="wide", page_icon="📝")
...
with tabs[0]:
    ...
    if not student_name.strip() or not roll_no.strip():
        ...
        if st.button("🚀 Calculate Scores & Generate Marksheet", type="primary"):
            ...
            # Sort: Qualified candidates are sorted higher based on Merit Score (P3-P6)
